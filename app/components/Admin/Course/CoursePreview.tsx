...
const CoursePreview: FC<Props> = ({ active, setActive, courseData, handleCourseCreate, isEdit }) => {
  ...
  return (
    <div className='w-[90%] m-auto py-5 mb-5'>
      ...
      <ul className='!list-disc pl-5 text-black dark:text-[#fff]'>
      ...
      <div className='w-full'>
        <div className='w-full 800px:pr-5 text-black dark:text-[#fff]'>
        ...
        {courseData?.benefits?.map((item: any, index: number) => (
          <div className='w-full flex 800px:items-center py-2 text-black dark:text-[#fff]' key={index}>
        ...
        <div className='w-full text-black dark:text-[#fff]'>
